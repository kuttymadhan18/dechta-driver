...
import { 
  ...
  Modal, Dimensions, Image, Linking, Alert, Clipboard
} from 'react-native';
...
// ═══════════════════════════════════════════════════════════════════════════
// PURE NATIVE SVG ICONS (Fallback if Feather doesn't have the exact match)
// ═══════════════════════════════════════════════════════════════════════════
...
export default function ProfileScreen() {
    ...
    const dbData = { 
        ...
        weightLimit: "750 kg", 
        modelName: "Mini Truck",
        bankAccount: "345678901234", 
        ifscCode: "HDFC0001234",
        aadharUrl: "active", panUrl: "active", licenseUrl: "active", rcUrl: null
    };

    const leaderboard = [
        { name: "You", earnings: 14500, trips: 62, rank: 1, isMe: true },
        { name: "Suresh K.", earnings: 13200, trips: 58, rank: 2, isMe: false },
        { name: "Karthik R.", earnings: 12800, trips: 55, rank: 3, isMe: false },
        { name: "Vikram S.", earnings: 11000, trips: 48, rank: 4, isMe: false },
        { name: "Manoj P.", earnings: 9500, trips: 42, rank: 5, isMe: false }
    ];
    ...
    const renderModal = () => {
        ...
        if (activeModal === 'achievements') {
            ...
            const mockGraphData: Record<string, {label: string, value: number}[]> = {
                ...
                <View>
                    ...
                    <View style={styles.statsGrid}>
                        <View style={[styles.statBox, {borderColor: '#BFDBFE', backgroundColor: '#EFF6FF'}]}>
                            <Text style={[styles.statLabel, {color: '#1D4ED8'}]}>Acceptance</Text>
                            <Text style={[styles.statValue, {color: '#1E3A8A'}]}>92%</Text>
                        </View>
            ...
            const formattedAccount = dbData.bankAccount.replace(/(\d{4})/g, '$1 ').trim();
                ...
                <View>
                    ...
                    <View style={styles.refCard}>
                        ...
                        <View style={styles.refRow}>
                            ...
                            <TouchableOpacity onPress={() => { Clipboard.setString(dbData.referralCode); Alert.alert('Copied!'); }} style={styles.refCopyBtn}>
             ...
             content = (
                <View style={{alignItems: 'center'}}>
                    ...
                    <View style={styles.sosCard}>
                        ...
                        <TouchableOpacity onPress={() => { Alert.alert('Alerting emergency contacts!'); setActiveModal(null); }} style={styles.sosBtn}>
        ...
        <SafeAreaView style={styles.container}>
            <ScrollView contentContainerStyle={styles.scrollPad} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.actionList}>
                    ...
                    <TouchableOpacity onPress={() => Alert.alert('Logged Out')} style={[styles.actionItem, {marginTop: 32, borderWidth: 0}]}>
            ...
            <Modal
                ...
                onRequestClose={() => setIsWalletOpen(false)}
            >
                <WalletView onClose={() => setIsWalletOpen(false)} initialBalance={dbData.walletBalance} />
            </Modal>
        </SafeAreaView>
    );
}
